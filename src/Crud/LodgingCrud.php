...
class LodgingCrud extends AbstractCrud
{
    ...
    /**
     * Takes the $request and deletes the lodging object from the database.
     * By default, it just deletes the lodging object as is and redirects to the referer page.
     *
     ...
     * If it returns 'save', it persists the lodging object, flushes and delete() continues.
     * If it returns 'exit', it interrupts delete() redirects to $redirectRoute.
     *
     */
    #[Route('lodging/{id}', name: 'app_lodging_delete', methods: ['POST'])]
    public function delete(Request $request, Lodging $object, string $redirectRoute = 'referer', array $redirectParams = [], ?callable $doBeforeDelete = null): Response
    {
