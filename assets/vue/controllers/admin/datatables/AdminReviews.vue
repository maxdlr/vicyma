...
<template>
    <VDatatable admin :title="title" :data="data" :searchable-properties="['user', 'rate', 'comment', 'lodging']"
        :exclude-from-row-properties="['id']" main-filter="rate"
        :date-filter="{ label: 'publication date', codeName: 'createdOn' }">
