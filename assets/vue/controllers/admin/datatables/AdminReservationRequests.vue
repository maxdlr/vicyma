...
const canBeConfirmed = (object) =>
  ["PENDING"].includes(getPropertyValue(object, "reservationStatus"));
const canBeArchived = (object) =>
  ["PENDING", "CONFIRMED", "PAID"].includes(
    getPropertyValue(object, "reservationStatus"),
  );
const canBeDeleted = (object) =>
  ["PENDING", "ARCHIVED"].includes(
    getPropertyValue(object, "reservationStatus"),
  );
const canBePaid = (object) =>
