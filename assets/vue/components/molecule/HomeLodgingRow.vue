...
<template>
  <article
      :class="[
          ...
          hovering ? clicked ? 'bg-primary-subtle' : 'border-info bg-info-subtle cursor-pointer' : ''
      ]"
  ...
  >
    ...
    <div class="my-auto col-12 col-md-7">
      ...
      <div class="my-3">
        ...
        <HomeLodgingDetail :content="`${lodging.roomCount} rooms`" detail="King beds"/>
        <HomeLodgingDetail :content="`Terrace`" :detail="`${lodging.terraceSurface} m2`"/>
      </div>
      <div class="my-3">
