...
<template>
    <div class="position-relative d-inline">
        <Button v-if="actionButton" :label="label" @mouseover="openYoyo" @click.prevent="toggleOpen"
            :icon-class-end="isOpen ? 'caret-up-fill' : 'caret-down-fill'" class="d-inline" />
        <Transition :name="direction.includes('up') ? SLIDE_UP : SLIDE_DOWN">
            <div v-if="isOpen" class="d-flex position-absolute px-2 pt-0 z-1030 my-3 mx-0" @mouseover="openYoyo" :class="[
                column ? 'flex-column' : '',
